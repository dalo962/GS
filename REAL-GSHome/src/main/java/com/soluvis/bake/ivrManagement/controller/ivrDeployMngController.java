...
import com.soluvis.bake.ivrManagement.service.ivrDeployMngService;
 ...
 */
@Controller
@RequestMapping(value = "/api/ivr/ivrDeployMng")
public class ivrDeployMngController extends commController{
	
	@Inject
	private ivrDeployMngService ivrDeployMngService;	
	...
	public @ResponseBody ApiResponse DeployMngCodeCheck(HttpServletRequest request) throws Exception {
		...
		try
		{	
			logger.info("ivrDeployMngService.DeployMngCodeCheck Query Start...");		
			search = ivrDeployMngService.DeployMngCodeCheck(map);
	...
	public @ResponseBody List<ivrDeployMng> DeployMngSearch(HttpServletRequest request) throws Exception {
		Map<String, Object> map = RequestUtil.getParameterMap(request); 
		
		List<ivrDeployMng> search = null;
		...
		{	
			...
			logger.info("ivrDeployMngService.DeployMngGet Query Start...");		
			search = ivrDeployMngService.DeployMngGet(map);
		}
		catch(Exception e)
		{
			e.printStackTrace();
    ...
    public @ResponseBody ApiResponse DeployMngSave(@Valid @RequestBody List<ivrDeployMng> deployMng, HttpServletRequest request) throws Exception {	
		...
		System.out.println(deployMng.size());
		try
		{
			for (ivrDeployMng dm : deployMng)
			{
				System.out.println(dm.getSeq());
				System.out.println(dm.getDirectory());
				System.out.println(dm.getDataStatus());
				...
				{		
					...
					logger.info("ivrDeployMngService.DeployMngIst Query Start...");
					sqlrst = ivrDeployMngService.DeployMngIst(map);
				...
				else if(AXBootTypes.DataStatus.MODIFIED.equals(dm.getDataStatus()))
				{
					...
					logger.info("ivrDeployMngService.DeployMngUdt Query Start...");
					sqlrst = ivrDeployMngService.DeployMngUdt(map);
				...
				else if(AXBootTypes.DataStatus.DELETED.equals(dm.getDataStatus()))
				{
					...
					logger.info("ivrDeployMngService.DeployMngDel Query Start...");
					sqlrst = ivrDeployMngService.DeployMngDel(map);
	...
	public @ResponseBody List<ivrDeployFile> DeployFileSearch(HttpServletRequest request) throws Exception {
		Map<String, Object> map = new HashMap<String, Object>(); 
		List<ivrDeployFile> search = null;
		
		try
		{	
			logger.info("ivrDeployMngService.DeployFileSearch Query Start...");			
			search = ivrDeployMngService.DeployFileGet(map);
		}
		catch(Exception e)
		{
			System.out.println(e.getMessage());
    ...
    public @ResponseBody ApiResponse DeployFileSave(@Valid @RequestBody List<ivrDeployFile> deployFile, HttpServletRequest request) throws Exception {	
		Map<String, Object> map = new HashMap<String, Object>();
		...
		try
		{
			for (ivrDeployFile df : deployFile)
			{
				...
				{		
					...
					logger.info("ivrDeployMngService.DeployFileIst Query Start...");
					sqlrst = ivrDeployMngService.DeployFileIst(map);
				...
				else if(AXBootTypes.DataStatus.MODIFIED.equals(df.getDataStatus()))
				{
					...
					logger.info("ivrDeployMngService.DeployFileUdt Query Start...");
					sqlrst = ivrDeployMngService.DeployFileUdt(map);
				...
				else if(AXBootTypes.DataStatus.DELETED.equals(df.getDataStatus()))
				{
					...
					logger.info("ivrDeployMngService.DeployFileDel Query Start...");
					sqlrst = ivrDeployMngService.DeployFileDel(map);
	...
	public @ResponseBody ApiResponse DeployMngSimple(@Valid @RequestBody List<ivrDeployMng> deployMng, HttpServletRequest request) throws Exception {
		if(DeployMngMkdir(deployMng,request).getMessage().indexOf("fail") > -1){
			return ok("디렉토리 체크 실패\n관리자에게 문의하세요.");
		}
		if(DeployMngBackup(deployMng,request).getMessage().indexOf("fail") > -1){
			return ok("시나리오 백업 실패\n관리자에게 문의하세요.");
		}		
    ...
    public @ResponseBody ApiResponse DeployMngValid(@Valid @RequestBody List<ivrDeployMng> deployMng, HttpServletRequest request) throws Exception {
		...
		for (int i = 0; i < arUuid.length; i++) {
			...
			param.put("uuid", uuid);
			logger.info("ivrDeployMngService.DeployFileGet Query Start...");
			List<ivrDeployFile> list = ivrDeployMngService.DeployFileGet(param);
		...
		Map<String, Object> map = new HashMap<String, Object>();
		List<ivrUrlList> Urlsearch = ivrUrlListService.UrlListGet(map);
		...
		try {
			...
			for (ivrDeployMng dm : deployMng) {
				...
				logger.info("ivrDeployMngService.DeployMngUdt Query Start...");
				sqlrst = ivrDeployMngService.DeployMngUdt(param);
    ...
    public @ResponseBody ApiResponse DeployMngMkdir(@Valid @RequestBody List<ivrDeployMng> deployMng, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody ApiResponse DeployMngBackup(@Valid @RequestBody List<ivrDeployMng> deployMng, HttpServletRequest request) throws Exception {
		...
		for (int i = 0; i < deployMng.size(); i++) {
			Map<String,Object> param = new HashMap<String,Object>();
			ivrDeployMng dm = deployMng.get(i);
    ...
    public @ResponseBody ApiResponse DeployMngDeploy(@Valid @RequestBody List<ivrDeployMng> deployMng, HttpServletRequest request) throws Exception {
		...
		for (int i = 0; i < Urlsearch.size(); i++) {
			try {
				...
				for (int j = 0; j < deployMng.size(); j++) {
					ivrDeployMng dm = deployMng.get(j);
		...
		for (int j = 0; j < deployMng.size(); j++) {
			...
			logger.info("ivrDeployMngService.DeployMngUdt Query Start...");
			sqlrst = ivrDeployMngService.DeployMngUdtResult(param);
    ...
    public @ResponseBody ApiResponse DeployMngRollback(@Valid @RequestBody List<ivrDeployMng> deployMng, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody ApiResponse DeployMngComplete(@Valid @RequestBody List<ivrDeployMng> deployMng, HttpServletRequest request) throws Exception {
		Map<String, Object> map = new HashMap<String, Object>();
