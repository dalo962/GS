...
import com.soluvis.bake.system.domain.log.ErrorLog;
import com.soluvis.bake.system.domain.log.ErrorLogService;

@Controller
@RequestMapping(value = "/api/v1/errorLogs")
public class ErrorLogViewController extends commController {
