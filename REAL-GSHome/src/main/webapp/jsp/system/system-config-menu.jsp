...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/plugins/ax5ui-mask/dist/ax5mask.js' />"></script>
    </jsp:attribute>
    <jsp:body>
                        ...
                        <ax:tbl clazz="ax-form-tbl" minWidth="500px">
                            ...
                            <ax:tr labelWidth="150px">
                                <ax:td label="ax.admin.menu.program.name" width="100%">
                                    <input type="hidden" name="menuId" id="menuId" data-ax-path="menuId" class="form-control"/>
                                    <input type="hidden" name="progNm" id="progNm" data-ax-path="progNm" class="form-control"/>
                                    <div class="form-group">
