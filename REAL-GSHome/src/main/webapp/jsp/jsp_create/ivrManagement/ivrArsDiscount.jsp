...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/js_create/ivrManagement/ivrArsDiscount.js?version=1'/>"></script>
    </jsp:attribute>
    <jsp:body>
        ...
        <ax:split-layout name="ax1" orientation="vertical">
            <ax:split-panel width="*" style="height:98%;">                
                <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                    <!--  
                    <div class="left">
                        <h2><i class="cqc-list"></i>ARS자동할인 목록</h2>
                    </div>
                    -->
                    <div class="right">     
