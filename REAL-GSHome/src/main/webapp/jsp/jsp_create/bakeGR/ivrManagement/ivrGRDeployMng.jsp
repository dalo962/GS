...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/js_create/bakeGR/ivrManagement/ivrGRDeployMng.js?version=2'/>"></script>      
        <style>
		.grid-cell-pink {
			background:#FFC1C1;
		}
    ...
    <jsp:body>
        ...
        <ax:split-layout name="ax1" orientation="vertical">
            <ax:split-panel width="*" style="height:98%;">    
                <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                	<div class="left">
                		<h5><b>※ 배포 프로세스 - 업로드 > 작성 > 정합성 > 백업 > 배포 > 완료 순으로 진행.</b></h5>
               		</div>
                    <div class="right">    
            ...
            <ax:split-panel width="5%" style="padding-right: 10px;">
            		<div style="position: absolute; text-align: center; transform: translate(-50%, -50%); left: 50%; top: 50%; ">
		           		<!-- 여기에 버튼이 두개 생겨야 해요 -->
		           		<button type="button" class="btn btn-primary" data-grid-view-02-btn="dirInsert" style="width:100%;height:30px;border:1px;"><i class="cqc-reply"></i> 작성</button>    
		           		<button type="button" class="btn btn-primary" data-grid-view-01-btn="valid" style="width:100%;height:30px;border:1px;margin-top:100px" ><i class="cqc-checkmark"></i> 정합성</button>
		           		<div class="H20"></div>
		           		<button type="button" class="btn btn-primary" data-grid-view-01-btn="backup" style="width:100%;height:30px;border:1px;" ><i class="cqc-save"></i> 백업</button>
		           		<div class="H20"></div>
            ...
            <ax:split-panel width="30%" style="height:98%;">    
                <div class="ax-button-group" data-fit-height-aside="grid-view-02">
                    ...
                    <div class="right">
                        ...
                        <button type="button" class="btn btn-default" data-grid-view-02-btn="save"><i class="cqc-save"></i> <ax:lang id="ax.admin.save"/></button>
                    </div>
                </div>
        ...
        <progress id="progressBar" value="0" max="12" style="width:100%"></progress>
	</jsp:body>
</ax:layout>
