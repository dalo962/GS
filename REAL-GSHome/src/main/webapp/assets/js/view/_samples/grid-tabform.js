        ...
        if (caller.formView01.validate()) {
            ...
            axboot.promise()
                .then(function (ok, fail, data) {
                    axboot.ajax({
                        type: "POST", url: ["samples", "parent"], data: JSON.stringify([parentData]),
                        callback: function (res) {
                            ok(res);
                        }
                    });
                ...
                .then(function (ok, fail, data) {
                    axboot.ajax({
                        type: "POST", url: ["samples", "child"], data: JSON.stringify(childList),
                        callback: function (res) {
                            ok(res);
                        }
                    });
...
fnObj.pageStart = function () {
    ...
    axboot.promise()
        .then(function (ok, fail, data) {
            axboot.ajax({
                type: "POST", url: ["commonCodes"], data: {groupCd: "USER_ROLE", useYn: "Y"},
                callback: function (res) {
                    var userRole = [];
