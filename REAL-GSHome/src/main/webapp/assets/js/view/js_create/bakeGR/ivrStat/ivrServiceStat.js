...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
        ...
        if(select == "day") {
        	columns = [row_date, weekday, did, service, n_incall, n_agentreq];
        } else if(select == "month") {
        	columns = [row_date, did, service, n_incall, n_agentreq];
        } else {
        	columns = [row_date, weekday, starttime, did, service, n_incall, n_agentreq];
        }
