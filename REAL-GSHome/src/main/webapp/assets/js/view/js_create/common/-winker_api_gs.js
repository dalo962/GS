...
function winkWebSocket()
{
	...
	this.wInitialize = function(strHostP, intPortP, strHostB, intPortB, strID, strPassword, strMode, strCenter, eventCallback, logCallback, consoleFlag, wssFlag)
	{
		...
		this.wConsoleFlag	= getBoolean(consoleFlag) ;
		...
		{
			if ( strHostP != strHostB || intPortP != intPortB )		this.wUriB = wProtocolType + strHostB + ":" + intPortB + "/" ;
			else {
	 ...
	 * @return		요청 접수 ReferenceID. -1 이면 요청 실패.
	 */
	this.wAddSkill = function(strPersonDBID, strSkillDBID, strSkillLevel)
	{
		this.wLog("wAddSkill","Add skill level....[" + strPersonDBID + "," + strSkillDBID + "," + strSkillLevel + "]");
		
		if ( this.isValidInt(strPersonDBID) == false ) return -1 ;
	 ...
	 * @return		요청 접수 ReferenceID. -1 이면 요청 실패.
	 */
	this.wAddSkillMulti = function(strPersonDBID, strSkillDBID, strSkillLevel)
	{
		this.wLog("wAddSkill","Add skill level multi....[" + strPersonDBID + "," + strSkillDBID + "," + strSkillLevel + "]");
	 ...
	 * @return		요청 접수 ReferenceID. -1 이면 요청 실패.
	 */
	this.wUpdateSkill = function(strPersonDBID, strSkillDBID, strSkillLevel)
	{
		this.wLog("wUpdateSkill","Update skill level....[" + strPersonDBID + "," + strSkillDBID + "," + strSkillLevel + "]");
	 ...
	 * @return		요청 접수 ReferenceID. -1 이면 요청 실패.
	 */
	this.wUpdateSkillMulti = function(strPersonDBID, strSkillDBID, strSkillLevel)
	{
		this.wLog("wUpdateSkill","Update skill level multi....[" + strPersonDBID + "," + strSkillDBID + "," + strSkillLevel + "]");
	 ...
	 * @return		요청 접수 ReferenceID. -1 이면 요청 실패.
	 */
	this.wDeleteSkill = function(strPersonDBID, strSkillDBID)
	{
		this.wLog("wDeleteSkill","Delete skill level....[" + strPersonDBID + "," + strSkillDBID + "]");
	 ...
	 *
	 * @param strPersonDBID	{required} 스킬을 추가할 상담사의 Person DBID 
	 * @param strSkillDBID	{required} 상담사에게 추가하고자 하는 스킬의 DBID. 여러개 하고자 할 경우 ',' 로 구분한다.
	 *
	 * @return		요청 접수 ReferenceID. -1 이면 요청 실패.
	 */
	this.wDeleteSkillMulti = function(strPersonDBID, strSkillDBID)
	{
		this.wLog("wDeleteSkill","Delete skill level multi....[" + strPersonDBID + "," + strSkillDBID + "]");
	 ...
	 * @return		요청 접수 ReferenceID. -1 이면 요청 실패.
	 */
	this.wRequestAddAgentToGroup = function(strPersonDBID, intAgentGroupDBID)
	{
		this.wLog("wRequestAddAgentToGroup","AddAgentToGroupRequest....[" + strPersonDBID + "," + intAgentGroupDBID + "]");
	 ...
	 * @return		요청 접수 ReferenceID. -1 이면 요청 실패.
	 */
	this.wRequestDeleteAgentFromGroup = function(strPersonDBID, intAgentGroupDBID)
	{
		this.wLog("wRequestDeleteAgentFromGroup","DeleteAgentFromGroupRequest....[" + strPersonDBID + "," + intAgentGroupDBID + "]");
	...
	{
		wLog("wUpdateAnnexOption","UpdateAnnexOption....[" + strDBID + "," + strSection + "," + strOption + "," + strValue + "]");
