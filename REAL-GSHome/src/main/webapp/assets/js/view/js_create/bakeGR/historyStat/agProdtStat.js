...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
    	...
    	axboot.ajax({
            type: "GET",
            url: "/gr/api/hist/agProdt/agProdtSearch",
            cache : false,
    ...
    MODAL_OPEN: function (caller, act, data) {
        ...
        axboot.modal.open({
            modalType: "AGPRODT_FACTOR_MODAL",
            //param: param,
            sendData: function () {
                return {
    ...
    DATA_SETTING: function (caller, act,data){
    	...
    	axboot.ajax({
             ...
             cache : false,
             data: {stat_gubun:"AGENT", dispname:"agProdt"},
             callback: function (res) {
             	var timedel = [];
...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    ...
    exportExcel: function () {
    	...
    	this.target.exportExcel("상담사 생산성 통계_" +sdt+"~"+edt+ ".xls");
    }
});