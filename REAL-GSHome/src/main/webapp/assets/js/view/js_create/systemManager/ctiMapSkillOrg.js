...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
        axboot.ajax({
            type: "POST",
            url: "/api/mng/ctiMapSkillOrg/selectSkillDetail",
            cache : false,
            data: JSON.stringify(caller.searchView.getData()),
            callback: function (res) {
            	console.log("PAGE_SEARCH selectSkillOrg callback " );
    ...
    PAGE_SAVE: function (caller, act, data) {
        ...
        axboot
            .call({
                type: "POST",
                url: "/api/mng/ctiMapSkillOrg/saveSkillOrg",
                cache : false,
            ...
            .call({
                type: "POST",
                url: "/api/mng/ctiMapSkillOrg/saveSkillDetail",
                cache : false,
    ...
    TREEITEM_CLICK: function (caller, act, data) {
    	...
    	axboot.ajax({
            type: "POST",
            url: "/api/mng/ctiMapSkillOrg/selectSkill",
            cache : false,
...
fnObj.searchView = axboot.viewExtend(axboot.searchView, {
    ...
    getData: function () {
		...
		if(tmpChnId != "")
		{	    	
			chnId = tmpChnId[0].value;
		} 
        var tmpId = $("[data-ax5select='selSkill']").ax5select("getValue");
		if(tmpId != "")
		{	    	
			id = tmpId[0].value;
		} 
    ...
    chnSearch: function(){
	    ...
	    axboot.ajax({
            ...
            callback: function (res) {
	        	...
	        	$("[data-ax5select='selChannel']").ax5select("setValue", $("#chnId").val());
                fnObj.searchView.skillSearch();
            }
        });
    },
    skillSearch: function(){
	    ...
	    axboot.ajax({
            ...
            callback: function (res) {
	        	...
	        	$("[data-ax5select='selSkill']").ax5select("setValue", $("#id").val());
            }
        });
    }
});
...
fnObj.treeView01 = axboot.viewExtend(axboot.treeView, {
        ...
        this.target = axboot.treeBuilder($('[data-z-tree="tree-view-01"]'), {
            ...
            callback: {
                ...
                onClick: function (e, treeId, treeNode, isCancel) {
                	//console.log(e.toString() + " / treeId : " + treeId + '/ treeNode.compId : ' + treeNode.compId + '/ treeNode.id : ' + treeNode.id + '/ isCancel : ' + isCancel);
    ...
    treeSearch: function (){
    	...
    	{
    		chnId = $("[data-ax5select='selChannel']").ax5select("getValue")[0].value;
    	}
        ...
        axboot.ajax({
            type: "POST",
            url: "/api/mng/ctiMapSkillOrg/selectSkillOrg",
            cache : false,
            data: JSON.stringify($.extend({}, data)),
            callback: function (res) {
...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "chnName", label: "채널", width: 200, align: "center"},
                {key: "name", label: "업무 스킬", width: 250, align: "center"},
                {key: "skillDbid", label: "CTI 스킬 DBID", width: 100, align: "center", editor: "text"},
                {key: "skillName", label: "CTI 스킬명", width: 220, align: "center", editor: "text"},
                {key: "agroupDbid", label: "CTI DG DBID", width: 100, align: "center", editor: "text"},
                {key: "agroupName", label: "CTI 그룹명", width: 220, align: "center", editor: "text"},                
    ...
    exportExcel: function () {
    	this.target.exportExcel("스킬그룹_CTI_매핑.xls");
    	//this.target.exportExcelXlsx("업무그룹 CTI매핑");
    }
});
