...
function winkWebSocket()
{
	...
	this.wConnectExt = function(connectFlag, wobject)
	{
		...
		try
		{
			wWebSocket = new WebSocket(this_.wUriC);
			if(wWebSocket != null  && typeof wWebSocket != "undefined")
			{
				this_.wWebSocket = wWebSocket;
	...
	{
		this.wLog("wDeleteSkill","Delete skill level....[" + strPersonDBID + "," + strSkillDBID + "]", true);
		...
		this.wLog("wDeleteSkill","Delete skill level request sent....", true);
