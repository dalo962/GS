...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
    	...
    	axboot.ajax({
            type: "GET",
            cache: false,
            url: "/api/ivr/ivrDeployMng/DeployMngSearch",
            data: data,
    ...
    PAGE_SEARCH_FILE: function (caller, act, data) {
    	...
    	axboot.ajax({
            type: "GET",
            cache: false,
            url: "/api/ivr/ivrDeployMng/DeployFileSearch",
            data: data,
            callback: function (res) {
    	...
    	axDialog.confirm({
            ...
            if (this.key == "ok") {
		    	axboot.ajax({
		            type: "POST",
		            cache: false,
		            url: "/api/ivr/ivrDeployMng/DeployMngSave",
    	...
    	axDialog.confirm({
            ...
            if (this.key == "ok") {
		    	axboot.ajax({
		            type: "POST",
		            cache: false,
		            url: "/api/ivr/ivrDeployMng/DeployFileSave",
		            data: JSON.stringify(saveList),
		            callback: function (res) {
		            	alert(res.message);
    ...
    PAGE_UPLOAD_FILE: function(){
    	...
    	$.ajax({
        	  	...
        	  	url: "/api/ivr/ivrDeployMng/DeployFileUpload",
        	  	data : formData,
        	  	processData: false,
        	  	contentType: false,
    	...
    	axDialog.confirm({
            ...
            if (this.key == "ok") {
            	...
            	axboot.ajax({
		            type: "POST",
		            cache: false,
		            url: "/api/ivr/ivrDeployMng/DeployMngValid",
		            		...
		            		axDialog.confirm({
		                    	...
		                    	if (this.key == "ok") {
		                    		...
		                    		axboot.ajax({
		            		            type: "POST",
		            		            cache: false,
		            		            url: "/api/ivr/ivrDeployMng/DeployMngMkdir",
		            		            data: JSON.stringify(validList),
    	...
    	axDialog.confirm({
            ...
            if (this.key == "ok") {
		    	...
		    	axboot.ajax({
		            type: "POST",
		            cache: false,
		            url: "/api/ivr/ivrDeployMng/DeployMngBackup",
    	...
    	axDialog.confirm({
            ...
            if (this.key == "ok") {
		    	...
		    	axboot.ajax({
		            type: "POST",
		            cache: false,
		            url: "/api/ivr/ivrDeployMng/DeployMngDeploy",
    	...
    	axDialog.confirm({
            ...
            if (this.key == "ok") {
		    	...
		    	axboot.ajax({
		            type: "POST",
		            cache: false,
		            url: "/api/ivr/ivrDeployMng/DeployMngRollback",
    	...
    	axDialog.confirm({
            ...
            if (this.key == "ok") {
		    	...
		    	axboot.ajax({
		            type: "POST",
		            cache: false,
		            url: "/api/ivr/ivrDeployMng/DeployMngComplete",
    ...
    PAGE_CODECHECK: function (caller, act, data) {
    	...
    	axboot.ajax({
            type: "POST",
            cache: false,
            url: "/api/ivr/ivrDeployMng/DeployMngCodeCheck",
            data: "",
            callback: function (res) {
    ...
    PAGE_SETEMITTER: function(){
    	eventSource = new EventSource("/api/ivr/ivrDeployMng/ConnectEmitter");
