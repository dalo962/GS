...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
    	...
    	axboot.ajax({
            type: "GET",
            url: "/gr/api/hist/agSkill/agSkillSearch",
            cache : false,
    ...
    MODAL_OPEN: function (caller, act, data) {
        ...
        axboot.modal.open({
            modalType: "AGSKILL_FACTOR_MODAL",
            //param: param,
            sendData: function () {
                return {
    ...
    DATA_SETTING: function (caller, act,data){
    	...
    	axboot.ajax({
             ...
             cache : false,
             data: {stat_gubun:"AGENT", dispname:"agSkill"},
             callback: function (res) {
             	var timedel = [];
...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    ...
    exportExcel: function () {
    	...
    	this.target.exportExcel("상담사 스킬 통계_" +sdt+"~"+edt+ ".xls");
    }
});