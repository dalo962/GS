...
//일 시 분 초 포멧터
ax5.ui.grid.formatter["day"] = function () {
	if(typeof this.value !== "undefined") {
		var pad = function(x) { return (x < 10) ? "0"+x : x;}
		var day = (parseInt(this.value / (60*60*24)) > 0) ? "D"+parseInt(this.value / (60*60*24))+ " ":"";
		
		return day + 
			   pad(parseInt(this.value / (60*60) % 24)) + ":" +
			   pad(parseInt(this.value / 60 % 60)) + ":" +
			   pad(this.value % 60);
	}
};

//시분초 포멧터
ax5.ui.grid.formatter["hour"] = function () {
	if(typeof this.value !== null && typeof this.value !== "undefined") {
		var pad = function(x) { return (x < 10) ? "0"+x : x;}
		var hour = pad(parseInt(this.value / (60*60)))// + ":" + 
		var min = pad(parseInt(this.value / 60 % 60))// + ":" + 
		var sec = String(parseInt(pad(this.value % 60)));
...
ax5.ui.grid.formatter["min"] = function () {
	if(typeof this.value !== "undefined") {
		var pad = function(x) { return (x < 10) ? "0"+x : x;}
		return pad(parseInt(this.value / 60)) + ":" +
			   pad(this.value % 60);
	}
};

//초 포멧터
ax5.ui.grid.formatter["sec"] = function () {
	if(typeof this.value !== "undefined") {
		var pad = function(x) { return (x < 10) ? "0"+x : x;}
...
//텍스트 포멧터
ax5.ui.grid.formatter["text"] = function () {
	if(typeof this.value !== "undefined") {
		return this.value;
	}
	/*var result = this.value;
	   if(typeof result !== "undefined") {      
	      if(result != "0"){
	         if(result.length == 6) result=result;
	         ...
	         else if(result.length == 1) result="00000"+result;
	         else result=result;
	         var text = result;
	         return text.substring(0,2)+":"+text.substring(3,2)+":"+text.substring(5,2);
	      }
	      else{
	         return "00:00:00";
	      }            
...
//카운트 포멧터
ax5.ui.grid.formatter["cnt"] = function () {
	/*
	if(typeof this.value !== "undefined") {
		return this.value;
	}
	*/
	if (typeof this.value !== "undefined") {
        ...
        return arrNumber.length > 1 ? arrNumber[0] + ax5.util.left(arrNumber[1], 2) : arrNumber[0].split('.')[0];
    } else {
        return "";
    }
};
...
//명 포멧터
ax5.ui.grid.formatter["person"] = function () {
	/*
	if(typeof this.value !== "undefined") {
		return this.value;
	}
...
//starttime 포맷터
ax5.ui.grid.formatter["major"] = function () {
	if(typeof this.value !== "undefined") {
		return this.value;
	}
};
...
//starttime 포맷터
ax5.ui.grid.formatter["texter"] = function () {
	if(typeof this.value !== "undefined") {
		return this.value;
	}
};
...
axboot.gridView = {
    ...
    moveRow: function (_type) {
    	var list = this.target.getList();
    	var delList = this.target.getList("deleted");
    	var index = this.target.selectedDataIndexs[0];
