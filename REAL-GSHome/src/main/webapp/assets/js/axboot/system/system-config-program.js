...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: "progNm", label: COL("ax.admin.program.name"), width: 200, align: "left", editor: "text"},
                {key: "progPh", label: COL("ax.admin.program.progPh"), width: 500, align: "left", editor: "text"},
                {key: "authCheck", label: COL("ax.admin.program.auth.check.or.not"), width: 120, align: "center", editor: "checkYn"},
                ...
                {key: "remark", label: COL("ax.admin.remark"), width: 150, editor: "text"}
            ],
            body: {
                onClick: function () {
