    ...
    UI.addClass({
        ...
        return function () {
            ...
            this.config = {
                ...
                virtualScrollAcceleratedDelayTime: 100,
...
(function () {
            ...
            var valueProcessor = {
                ...
                "treeControl": function treeControl(__value) {
                    ...
                    if (_item[keys.children].length) {
                    	...
                    	// 20210304
                    	indentNodeHtml += '<span ' + 'data-ax5grid-tnode-arrow="" ' + 'style="width: ' + cfg.tree.arrowWidth + 'px;padding-left:1px;"' + '>&nbsp;</span>';
                    }
  ...
  //2020 콜통계 개선. xlsx export용
    ...
    GRID.body = {
        ...
        getExcelStringXlsx: getExcelStringXlsx, //2020 콜통계 개선. 추가
    ...
    //html 테이블 용
      ...
      var parsingColumns = function parsingColumns (row) {
    	  ...
    	  for(var i=0; i<tmp.length; i++){
    		  ...
    		  tmpColumns.push({data:data, colspan:colspan, rowspan:rowspan});
    	  }    	     	  
...
(function () {
    ...
    GRID.header = {
        ...
        getExcelString: getExcelString,
        getExcelStringXlsx: getExcelStringXlsx //2020 콜통계 개선. xlsx export용
    };
})();
