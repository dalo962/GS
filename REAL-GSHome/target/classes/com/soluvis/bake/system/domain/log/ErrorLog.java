...
import com.soluvis.bake.system.domain.SimpleJpaModel;
...
public class ErrorLog extends SimpleJpaModel<Long> implements AXBootErrorLog {
    ...
    @SequenceGenerator(name="SEQ_ERROR_LOG_M", sequenceName="SEQ_ERROR_LOG_M", allocationSize = 1, initialValue = 1)
    private Long id;
